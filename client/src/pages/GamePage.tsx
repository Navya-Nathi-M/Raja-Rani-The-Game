...
import { Room, Role, Player } from '../types/game';
...
export const GamePage = () => {
  ...
  useEffect(() => {
    const handlePhaseChanged = (phaseData: PhaseData) => {
      ...
      if (phaseData.phase === 'police-reveal') {
        ...
        setWinner({
          name: phaseData.data.winner!,
          points: phaseData.data.points!,
        });
      }
    };
  ...
  return (
    <div className="p-8 max-w-lg mx-auto">
      ...
      <div className="border rounded p-4 bg-yellow-50 mb-6">
        <p className="text-center text-lg">
          ...
          {myRole ? (
            ...
            <span className="italic text-gray-400">Waiting...</span>
          )}
        </p>
      </div>
      ...
      {currentPhase === 'verdict' && verdict && (
        ...
        >
          ...
          <p className="text-center">
            ...
            {verdict.isCorrect
              ? ' — Police gets bonus points!'
              : ' — Thief gets bonus points!'}
          </p>
      ...
      {currentPhase === 'police-reveal' && myRole !== 'Police' && (
        <p className="text-center text-gray-400 italic">
          Watch the Police make their accusation...
        </p>
      )}
    </div>
  );
